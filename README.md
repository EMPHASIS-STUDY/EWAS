...
1. Run `EPIC_analysis/01_meffil_QC.R path cores` as an R batch job where:
...
5. Run `EPIC_analysis/02_meffil_norm.R path PCs batch cores` as an R batch job where:
* `path` = as above
